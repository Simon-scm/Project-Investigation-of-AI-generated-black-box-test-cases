\section{Problemstellung, Forschungsfrage und Vorgehen}
...
bei einzelnen speziellen Eingaben fehlschlägt.
...
anspruchsvolle Aufgabe dar. Angesichts des zunehmenden Einsatzes künstlicher Intelligenz (\acs{KI})\acused{KI} im Feld der Softwareentwicklung entsteht die Frage, ob mit Hilfe der künstlichen Intelligenz 
...
Das Ziel dieser Projektarbeit besteht darin, ein \ac{KI}-Assistenzsystem in Form einer Webanwendung zu entwickeln, welches Testfälle inklusive der erwarteten Ergebnisse 
für natürlichsprachliche Programmieraufgaben ausgibt. Auf Basis dieser Anwendung wird anschließend anhand von sieben beispielhaften Aufgaben untersucht, wie valide die generierten 
Testfälle sind und wie gut sie fehlerhafte Implementierungen einer Lösung erkennen. Wichtig hierbei ist, dass die \ac{KI} keinen Zugriff auf die Implementierungen selbst erhält und 
die Testfälle somit ausschließlich auf Basis des beschriebenen Sollverhaltens innerhalb der Aufgabe abgeleitet werden. Daraus ergibt sich die folgende Forschungsfrage:
...
fachliche Prüfung der generierten Testfälle erforderlich bleibt.
\clearpage
Dafür werden zunächst die Grundlagen des Software-Testings und die Testfallgenerierung mit Hilfe von
\ac{KI} erläutert. Dies schafft das fachliche Fundament für die spätere Bewertung der
generierten Testfälle. Anschließend werden die Konzeption und technische Umsetzung des
Assistenzsystems beschrieben, um herauszustellen, wie die theoretischen Anforderungen in einen
