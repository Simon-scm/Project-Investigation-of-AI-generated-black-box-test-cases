...
anspruchsvolle Aufgabe dar. Angesichts des zunehmenden Einsatzes von KI-Systemen im Feld der Softwareentwicklung entsteht die Frage, ob mit Hilfe der künstlichen Intelligenz 
...
Das Ziel dieser Projektarbeit besteht darin, ein KI-Assistenzsystem in Form einer Webanwendung zu entwickeln, welches Testfälle inklusive der erwarteten Ergebnisse 
...
Testfälle sind und wie gut sie fehlerhafte Implementierungen einer Lösung erkennen. Wichtig hierbei ist, dass die KI keinen Zugriff auf die Implementierungen selbst erhält und 
