...
Auffällig ist, dass bei den ausgewählten Aufgaben scheinbar kein Zusammenhang zwischen der 
...
Der einzelne Sollwertfehler bei Problem 3 ist insofern interessant, als dass bei vergleichbaren Testfällen zu der selben Aufgabe keine fehlerhaften Werte für das erwartete 
Ergebnis auftraten. 
...
Ein Testfall erkennt eine falsche Implementierung, wenn das in dem Testfall definierte erwartete Ergebnis 
...
einem fehlererkennenden Testfall pro Aufgabe als optimal zu bewerten, da das \ac{LLM} so nicht weitere Testfälle für den gleichen 
...
Testfällen nicht solche dabei sind, die möglicherweise andere, von dem \ac{LLM} antizipierte Fehlerimplementierungen, identifizieren 
würden.
...
Stichprobe nahe, dass die Generierung fehlererkennender Testfälle weniger von der semantischen Komplexität der Aufgabenstellung, sondern mehr 
