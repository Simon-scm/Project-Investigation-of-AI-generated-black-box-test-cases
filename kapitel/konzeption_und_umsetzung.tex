...
Abbildung~\ref{fig:systemablauf} verdeutlicht den internen prozeduralen Ablauf der Anwendung.
...
Die Anwendung besteht aus einem mit Python und dem Framework FastAPI 
realisierten Backend sowie einer mit HTML, CSS und JavaScript umgesetzten Benutzeroberfläche. Beide Bestandteile werden gemeinsam innerhalb eines Serverprozesses 
betrieben. Über die Route GET / stellt das Backend die statischen Dateien der Benutzeroberfläche bereit und liefert sie an den Browser aus.
