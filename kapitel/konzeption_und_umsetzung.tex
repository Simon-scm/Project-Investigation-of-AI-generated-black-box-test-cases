...
realisierten Backend sowie einer mit HTML, CSS \cite{openai_sol_2026} und JavaScript umgesetzten Benutzeroberfläche (Anhang~\ref{anhang:web-ui}). Beide Bestandteile werden gemeinsam innerhalb eines Serverprozesses 
...
übermittelt. Diese Trennung verhindert, dass Instruktionen zur Rolle des LLMs, zum
...
\begin{enumerate}
    ...
    \item \textbf{Gültigkeitsbedingungen:} Alle in der Aufgabenbeschreibung
          ...
          vermeiden.
    \item \textbf{Ausgabevertrag:} Die Antwort des LLMs soll ausschließlich aus einem
