...
realisierten Backend sowie einer mit \acs{HTML}, \acs{CSS} \cite{openai_sol_2026} und JavaScript umgesetzten Benutzeroberfläche (Anhang~\ref{anhang:web-ui}). Beide Bestandteile werden gemeinsam innerhalb eines Serverprozesses 
