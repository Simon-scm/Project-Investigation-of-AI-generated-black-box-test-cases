...
Dieser System-Prompt stellt eine entscheidende Möglichkeit dar, indirekt Einfluss auf die Qulität der Ausgabe und somit auf die 
Qualität der generierten Testfälle zu nehmen.
Die vom Nutzer eingegebene konkrete Aufgabenbeschreibung wird davon getrennt als Benutzernachricht
...
\begin{enumerate}
    ...
    \item \textbf{Gültigkeitsbedingungen:} Alle in der Aufgabenbeschreibung
          ...
          vermeiden.
    \item \textbf{Ausgabevertrag:} Die Antwort des LLM's soll ausschließlich aus einem
          gültigen JSON-Objekt bestehen. Jeder einzelne Testfall enthält die für die
...
Der ganzheitliche System-Prompt kann dem ANHANG entnommen werden.

Das vorgegebene JSON-Ausgabeformat wurde gewählt um die
Antwort in der Benutzeroberfläche konsistent und kompakt darstellbar zu machen und
um die Testfälle ohne manuelle Umformung in die von dem Projekt verwendete Testsimulation
einlesen zu können.
...
Wie im vorherigen Kapitel beschrieben erzeugt ein LLM seine Antwort auf Basis 
...
korrekten Referenzimplementierung validiert und erst nach Ausschluss
