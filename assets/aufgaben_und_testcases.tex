\definecolor{darkgreen}{RGB}{0,100,30}
...
Die folgende Auflistung enthält die Aufgabenbeschreibungen und Eingabebeschränkungen (Constraints), die daraus generierten Testfälle 
sowie eine Erklärung der jeweiligen Aufgabe. Die Testfälle sind nach folgendem Schema farblich markiert:
rot = Constraint-Verstoß,
orange = falscher Sollwert,
grün = erkennt fehlerhafte Implementierung.
...
\begin{lstlisting}[style=appendixdata, escapeinside={(*@}{@*)}]
{
  "test1": {"n": 5, "expected": true},
  "test2": {"n": 7, "expected": false},
  "test3": {"n": 10, "expected": true},
  "test4": {"n": 11, "expected": false},
  (*@\mbox{\textcolor{darkgreen}{\ttfamily\detokenize{"test5": {"n": 1, "expected": true},}}}@*)
  (*@\mbox{\textcolor{red}{\ttfamily\detokenize{"test6": {"n": 0, "expected": false},}}}@*)
  "test7": {"n": 1431655765, "expected": true},
  (*@\mbox{\textcolor{red}{\ttfamily\detokenize{"test8": {"n": 2863311530, "expected": false},}}}@*)
...
\subsection{Problem 2: Sort Vowels by Frequency (LeetCode 3913)}
...
into the vowel positions results in \enquote{leetcedo}.
...
\begin{lstlisting}[style=appendixdata, escapeinside={(*@}{@*)}]
{
  ...
  (*@\mbox{\textcolor{brown}{\ttfamily\detokenize{"test4": {"s": "uauaueiouaeiou", "expected": "uuaaaeeiiouou"},}}}@*)
  "test5": {"s": "xyz", "expected": "xyz"},
  (*@\mbox{\textcolor{brown}{\ttfamily\detokenize{"test6": {"s": "aebecidofu", "expected": "aaebecidofu"},}}}@*)
  (*@\mbox{\textcolor{darkgreen}{\ttfamily\detokenize{"test7": {"s": "oooeeeiiiaaa", "expected": "oooeeeiiiaaa"},}}}@*)
  (*@\mbox{\textcolor{brown}{\ttfamily\detokenize{"test8": {"s": "aeaeaeaeaeaeae", "expected": "aeaeaeaeaeaeae"},}}}@*)
  (*@\mbox{\textcolor{brown}{\ttfamily\detokenize{"test9": {"s": "aeiouaeiouaeiou", "expected": "aeiouaeiouaeiou"},}}}@*)
  (*@\mbox{\textcolor{brown}{\ttfamily\detokenize{"test10": {"s": "bbeeiioouu", "expected": "bbeeiiouou"},}}}@*)
  (*@\mbox{\textcolor{brown}{\ttfamily\detokenize{"test11": {"s": "aeaeiouioiuoaeae", "expected": "aeaeaeaeouiouiou"},}}}@*)
  "test12": {"s": "azbzczdz", "expected": "azbzczdz"},
  (*@\mbox{\textcolor{brown}{\ttfamily\detokenize{"test13": {"s": "eioaeuu", "expected": "uuueioa"},}}}@*)
  "test14": {"s": "aaeeiioouu", "expected": "aaeeiioouu"},
  (*@\mbox{\textcolor{brown}{\ttfamily\detokenize{"test15": {"s": "uuuuiiiiiaaaaeeee", "expected": "uuuuiiiiiaaaaeeee"}}}}@*)
}
\end{lstlisting}
...
sollen ihre ursprüngliche Position beibehalten. Algorithmisch besteht die Herausforderung darin, dass die Vokalhäufigkeiten und die initiale Ordnung der Vokale bestimmt 
werden müssen, woraufhin eine sortierte Vokalfolge erstellt werden kann, um diese auf die ursprüngliche Zeichenkette anzuwenden.
...
\begin{lstlisting}[style=appendixdata, escapeinside={(*@}{@*)}]
{
  ...
  (*@\mbox{\textcolor{darkgreen}{\ttfamily\detokenize{"test9": {"head": [1,2,3,4,5], "k": 5, "expected": [1,2,3,4,5]},}}}@*)
  "test10": {"head": [1,2,3,4,5], "k": 7, "expected": [4,5,1,2,3]},
  "test11": {"head": [1,2,3,4,5], "k": 13, "expected": [3,4,5,1,2]},
  (*@\mbox{\textcolor{brown}{\ttfamily\detokenize{"test12": \{"head": [10,-10,20,-20,30,-30], "k": 3, "expected": }}}@*)
  (*@\mbox{\textcolor{brown}{\ttfamily\detokenize{[20,-20,30,-30,10,-10]\},}}}@*)
  "test13": {"head": [0,0,0,0], "k": 2, "expected": [0,0,0,0]},
  (*@\mbox{\textcolor{darkgreen}{\ttfamily\detokenize{"test14": {"head": [100,99,-99,-100], "k": 4, "expected": [100,99,-99,-100]},}}}@*)
  "test15": {"head": [1,2], "k": 1000000001, "expected": [2,1]}
}
\end{lstlisting}

\subsubsection*{Erklärung der Aufgabe}
Eine verkettete Liste soll um eine vorgegebene Anzahl an Positionen (k) nach rechts verschoben werden. Das Verschieben der einzelnen 
Knoten wird durch das Verbinden der verketteten Liste und das Trennen an einer anderen Stelle abgebildet.
...
\begin{lstlisting}[style=appendixdata, escapeinside={(*@}{@*)}]
{
  ...
  (*@\mbox{\textcolor{darkgreen}{\ttfamily\detokenize{"test4": { "gain": [-100, -100, -100], "expected": 0 },}}}@*)
  "test5": { "gain": [100, -50, -40, 10], "expected": 100 },
  (*@\mbox{\textcolor{darkgreen}{\ttfamily\detokenize{"test6": { "gain": [-2, -1, -2, -1], "expected": 0 },}}}@*)
  "test7": { "gain": [1, 2, 3, 4, 5], "expected": 15 },
  (*@\mbox{\textcolor{darkgreen}{\ttfamily\detokenize{"test8": { "gain": [-1, -2, -3, -4, -5], "expected": 0 },}}}@*)
  "test9": { "gain": [10, -5, 15, -10, 20], "expected": 30 },
  (*@\mbox{\textcolor{darkgreen}{\ttfamily\detokenize{"test10": { "gain": [-10, 5, -15, 10, -20], "expected": 0 },}}}@*)
  "test11": { "gain": [0], "expected": 0 },
  "test12": { "gain": [100], "expected": 100 },
  (*@\mbox{\textcolor{darkgreen}{\ttfamily\detokenize{"test13": { "gain": [-100], "expected": 0 },}}}@*)
...
\subsubsection*{Erklärung der Aufgabe}
Die Aufgabe beschreibt eine Autofahrt, die auf Höhe 0 beginnt. Ein Array beinhaltet die relativen Höhenänderungen zwischen 
aufeinanderfolgenden Punkten. Gesucht wird die höchste während der Fahrt erreichte Höhe, was algorithmisch der Bestimmung der höchsten Präfixsumme entspricht.
...
\begin{lstlisting}[style=appendixdata, escapeinside={(*@}{@*)}]
{
  (*@\mbox{\textcolor{red}{\ttfamily\detokenize{"test1": {"a": 0, "b": 0, "c": 0, "expected": 0},}}}@*)
  (*@\mbox{\textcolor{red}{\ttfamily\detokenize{"test2": {"a": 0, "b": 0, "c": 1, "expected": 1},}}}@*)
  (*@\mbox{\textcolor{red}{\ttfamily\detokenize{"test3": {"a": 1, "b": 1, "c": 0, "expected": 2},}}}@*)
  "test4": {"a": 2, "b": 4, "c": 6, "expected": 0},
  "test5": {"a": 2, "b": 4, "c": 7, "expected": 1},
  "test6": {"a": 8, "b": 7, "c": 15, "expected": 0},
  (*@\mbox{\textcolor{red}{\ttfamily\detokenize{"test7": {"a": 8, "b": 7, "c": 0, "expected": 5},}}}@*)
  (*@\mbox{\textcolor{red}{\ttfamily\detokenize{"test8": {"a": 15, "b": 15, "c": 0, "expected": 8},}}}@*)
  "test9": {"a": 10, "b": 5, "c": 15, "expected": 0},
  (*@\mbox{\textcolor{red}{\ttfamily\detokenize{"test10": {"a": 10, "b": 5, "c": 0, "expected": 6},}}}@*)
  (*@\mbox{\textcolor{red}{\ttfamily\detokenize{"test11": {"a": 7, "b": 0, "c": 15, "expected": 1},}}}@*)
  "test12": {"a": 1, "b": 2, "c": 4, "expected": 3},
  "test13": {"a": 3, "b": 5, "c": 7, "expected": 0},
  "test14": {"a": 1, "b": 1, "c": 3, "expected": 1},
  (*@\mbox{\textcolor{red}{\ttfamily\detokenize{"test15": {"a": 31, "b": 0, "c": 16, "expected": 4}}}}@*)
}
\end{lstlisting}
...
\begin{lstlisting}[style=appendixdata, escapeinside={(*@}{@*)}]
{
  ...
  (*@\mbox{\textcolor{darkgreen}{\ttfamily\detokenize{"test10": \{"nums": [2, 2, 1, 0, 0, 1, 1, 2, 0], "expected": }}}@*)
  (*@\mbox{\textcolor{darkgreen}{\ttfamily\detokenize{[0, 0, 0, 1, 1, 1, 2, 2, 2]\},}}}@*)
  (*@\mbox{\textcolor{darkgreen}{\ttfamily\detokenize{"test11": {"nums": [1, 0, 0, 2, 1, 2, 0], "expected": [0, 0, 0, 1, 1, 2, 2]},}}}@*)
  (*@\mbox{\textcolor{darkgreen}{\ttfamily\detokenize{"test12": \{"nums": [1, 2, 1, 0, 0, 2, 1, 0, 2], "expected": }}}@*)
  (*@\mbox{\textcolor{darkgreen}{\ttfamily\detokenize{[0, 0, 0, 1, 1, 1, 2, 2, 2]\},}}}@*)
...
\subsubsection*{Erklärung der Aufgabe}
Ein Array aus den Werten 0, 1 und 2, welche die Farben rot, weiß und blau repräsentieren, soll ohne die Verwendung von Bibliotheksfunktionen 
...
\begin{lstlisting}[style=appendixdata, escapeinside={(*@}{@*)}]
{
  ...
  (*@\mbox{\textcolor{darkgreen}{\ttfamily\detokenize{"test15": {"nums": [1, 1, 2, 2, 3, 3, 4, 4], "k": 5, "expected": 4}}}}@*)
}
\end{lstlisting}

\subsubsection*{Erklärung der Aufgabe}
Aus einem Zahlenarray sollen möglichst viele Paare gefunden und entfernt werden, deren Summe einem vorgegebenen Wert k entspricht. 
